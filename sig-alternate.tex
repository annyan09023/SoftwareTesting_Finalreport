...
\usepackage{color}
%\usepackage{listings}
%\lstset{language=C++,frame=lrb,xleftmargin=\fboxsep,xrightmargin=-\fboxsep}
...
\keywords{idempotency, concurrenty bugs, failure recovery, static analysis, bug
fixing}

\input{Introduction}
\input{ConAirOverview}
\input{Design}
